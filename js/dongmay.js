    ...
    $(document).ready(function(){
        ...
        if (name) {
            ...
            if (greetingElement) {
                ...
                contentElement.innerText = `Sẽ thật hành phúc khi được gặp gỡ và đón tiếp ${decodedName} trong ngày trọng đại của chúng tôi/em. Xin gửi đến ${decodedName} lời cảm ơn chân thành và sâu sắc nhất - sự hiện diện của ${decodedName} là niềm vui và là món quà vô cùng ý nghĩa đối với chúng tôi/em!`;
